...
#for chr in {1..22}; do
    time $fs camgwas.cp -v -n -phasefiles chr{1..22}_phasedWref.phase -recombfiles chr{1..22}_phasedWref.recombfile -idfile camgwasPhasedWref.ids -import example2_bestpractice.settings -s34args:"-X -Y" -numthreads 15 -go
#done
