...
################ Male Heterozygosity #####################################
het2=read.table("mxchr-het.het", header = T, as.is = T)
mis2=read.table("mxchr-miss.imiss", header = T, as.is = T)
...
het3=read.table("fxchr-het.het", header = T, as.is = T)
mis3=read.table("fxchr-miss.imiss", header = T, as.is = T)
