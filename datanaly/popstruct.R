...
for(i in 1:nrow(pcastat)){
 if(pcastat[i,6]=='ACB') points(pcastat[i,4], pcastat[i,5], col=6, pch=19)
 if(pcastat[i,6]=='ASW') points(pcastat[i,4], pcastat[i,5], col=6, pch=19)
 if(pcastat[i,6]=='BEB') points(pcastat[i,4], pcastat[i,5], col=5, pch=19)
 if(pcastat[i,6]=='CDX') points(pcastat[i,4], pcastat[i,5], col=2, pch=19)
 if(pcastat[i,6]=='CEU') points(pcastat[i,4], pcastat[i,5], col=4, pch=19)
 if(pcastat[i,6]=='CHB') points(pcastat[i,4], pcastat[i,5], col=2, pch=19)
 if(pcastat[i,6]=='CHS') points(pcastat[i,4], pcastat[i,5], col=2, pch=19)
 if(pcastat[i,6]=='CLM') points(pcastat[i,4], pcastat[i,5], col=3, pch=19)
 if(pcastat[i,6]=='ESN') points(pcastat[i,4], pcastat[i,5], col=6, pch=19)
 if(pcastat[i,6]=='FIN') points(pcastat[i,4], pcastat[i,5], col=4, pch=19)
 if(pcastat[i,6]=='GBR') points(pcastat[i,4], pcastat[i,5], col=4, pch=19)
 if(pcastat[i,6]=='GIH') points(pcastat[i,4], pcastat[i,5], col=5, pch=19)
 if(pcastat[i,6]=='GWD') points(pcastat[i,4], pcastat[i,5], col=6, pch=19)
 if(pcastat[i,6]=='IBS') points(pcastat[i,4], pcastat[i,5], col=4, pch=19)
 if(pcastat[i,6]=='ITU') points(pcastat[i,4], pcastat[i,5], col=5, pch=19)
 if(pcastat[i,6]=='JPT') points(pcastat[i,4], pcastat[i,5], col=2, pch=19)
 if(pcastat[i,6]=='KHV') points(pcastat[i,4], pcastat[i,5], col=2, pch=19)
 if(pcastat[i,6]=='LWK') points(pcastat[i,4], pcastat[i,5], col=6, pch=19)
 if(pcastat[i,6]=='MSL') points(pcastat[i,4], pcastat[i,5], col=6, pch=19)
 if(pcastat[i,6]=='MXL') points(pcastat[i,4], pcastat[i,5], col=3, pch=19)
 if(pcastat[i,6]=='PEL') points(pcastat[i,4], pcastat[i,5], col=3, pch=19)
 if(pcastat[i,6]=='PJL') points(pcastat[i,4], pcastat[i,5], col=5, pch=19)
 if(pcastat[i,6]=='PUR') points(pcastat[i,4], pcastat[i,5], col=3, pch=19)
 if(pcastat[i,6]=='STU') points(pcastat[i,4], pcastat[i,5], col=5, pch=19)
 if(pcastat[i,6]=='TSI') points(pcastat[i,4], pcastat[i,5], col=4, pch=19)
 if(pcastat[i,6]=='YRI') points(pcastat[i,4], pcastat[i,5], col=6, pch=19)
...
plot(pcastat[,4], pcastat[,5], xlab="PC1", ylab="PC2", type="n")
for(i in 1:nrow(pcastat)){
  if(pcastat[i,6]=='ACB') points(pcastat[i,4], pcastat[i,5], col=8, pch=19)
  if(pcastat[i,6]=='ASW') points(pcastat[i,4], pcastat[i,5], col=7, pch=19)
  if(pcastat[i,6]=='BEB') points(pcastat[i,4], pcastat[i,5], col=5, pch=19)
  if(pcastat[i,6]=='CDX') points(pcastat[i,4], pcastat[i,5], col=2, pch=19)
  if(pcastat[i,6]=='CEU') points(pcastat[i,4], pcastat[i,5], col=4, pch=19)
  if(pcastat[i,6]=='CHB') points(pcastat[i,4], pcastat[i,5], col=2, pch=19)
...
legend(x=c(-0.09,0.20),y=c(-0.1555,-0.20), 
       c("AFR","SAS","EAS","AMR","EUR","ACB","ASW","CASECON"), pch = 19, 
...
for(i in 1:nrow(pcastat2)){
  if(pcastat2[i,14]=='CASE') points(pcastat2[i,4], pcastat2[i,5], col=2, pch=19)
  if(pcastat2[i,14]=='CONTROL') points(pcastat2[i,4], pcastat2[i,5], col=4, pch=19)
}

# Pop struct based on PC3 and PC4
plot(pcastat2[,6], pcastat2[,7], xlab = "PC3", ylab = "PC4", type = "n")
for(i in 1:nrow(pcastat2)){
  if(pcastat2[i,14]=='CASE') points(pcastat2[i,6], pcastat2[i,7], col=2, pch=19)
  if(pcastat2[i,14]=='CONTROL') points(pcastat2[i,6], pcastat2[i,7], col=4, pch=19)
}

# Pop struct based on PC5 and PC6
plot(pcastat2[,8], pcastat2[,9], xlab = "PC5", ylab = "PC6", type = "n")
for(i in 1:nrow(pcastat2)){
  if(pcastat2[i,14]=='CASE') points(pcastat2[i,8], pcastat2[i,9], col=2, pch=19)
  if(pcastat2[i,14]=='CONTROL') points(pcastat2[i,8], pcastat2[i,9], col=4, pch=19)
}

# Pop struct based on PC7 and PC8
plot(pcastat2[,10], pcastat2[,11], xlab = "PC7", ylab = "PC8", type = "n")
for(i in 1:nrow(pcastat2)){
  if(pcastat2[i,14]=='CASE') points(pcastat2[i,10], pcastat2[i,11], col=2, pch=19)
  if(pcastat2[i,14]=='CONTROL') points(pcastat2[i,10], pcastat2[i,11], col=4, pch=19)
}

# Pop struct based on PC9 and PC10
plot(pcastat2[,12], pcastat2[,13], xlab = "PC9", ylab = "PC10", type = "n")
for(i in 1:nrow(pcastat2)){
  if(pcastat2[i,14]=='CASE') points(pcastat2[i,12], pcastat2[i,13], col=2, pch=19)
